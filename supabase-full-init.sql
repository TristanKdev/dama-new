...
INSERT INTO menu_items (id, name_ko, name_en, description, price, category, dietary_tags, image_url, available, sold_out, serving_size, spice_level, subcategory) VALUES
  ...
  ('ueong-jorim', '우엉조림', 'Lotus Root Stir-Fry', 'Lotus root in glossy soy glaze. Crisp-chewy, earthy, uniquely Korean.', 5.00, 'banchan', ARRAY['Vegan','Dairy-Free'], '/images/food/banchan/yeongeun-jorim.jpg', true, false, '5 oz', 0, 'jorim'),
