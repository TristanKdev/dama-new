...
const ENRICHMENT_DATA: Record<string, EnrichmentEntry> = {
  ...
  'kabocha-squash-salad': {
    ...
    subcategory: 'muchim',
    glossary: 'A sweet, dense pumpkin variety widely used in Korean cooking — naturally creamy.',
  ...
  'seasoned-radish-namul': {
    ...
    badges: ['Vegan', 'Mild'],
    subcategory: 'muchim',
    glossary: 'Seasoned Korean vegetable side dish, dressed with sesame oil, garlic, and soy sauce.',
  ...
  'stuffed-cucumber-kimchi': {
    ...
    subcategory: 'kimchi',
    glossary: 'Cucumber kimchi — stuffed with seasoned chive and chili filling, fermented for tangy crunch.',
  ...
  'king-oyster-mushroom-stir-fry': {
    ...
    subcategory: 'bokkeum',
    glossary: 'Korean stir-fry — thick-cut king oyster mushrooms with bell peppers and chili.',
  ...
  'fish-cake-stir-fry': {
    ...
    badges: ['Mild'],
    subcategory: 'bokkeum',
    glossary: 'Korean fish cake stir-fry — sliced eomuk in a savory-sweet soy glaze.',
  ...
  'seasoned-bean-sprouts': {
    ...
    badges: ['Vegan', 'Mild'],
    subcategory: 'muchim',
    glossary: 'Seasoned Korean vegetable side dish — blanched bean sprouts with sesame and garlic.',
  ...
  'soy-braised-eggs': {
    ...
    subcategory: 'jorim',
    glossary: 'Korean braised eggs — slow-cooked in a savory soy sauce until deeply seasoned.',
  ...
  'glass-noodle-stir-fry-japchae': {
    ...
    subcategory: 'bokkeum',
    glossary: 'Korean glass noodles — sweet potato starch noodles stir-fried with vegetables and sesame soy sauce.',
  ...
  'pan-fried-tofu': {
    ...
    badges: ['Vegan', 'Mild'],
    subcategory: 'bokkeum',
    glossary: 'Korean pan-fried tofu — golden-crisp outside, soft inside. A clean, protein-rich banchan.',
  ...
  'broccoli-tofu-stir-fry': {
    ...
    subcategory: 'bokkeum',
    glossary: 'Korean vegetable stir-fry — broccoli and tofu lightly seasoned with sesame and soy.',
  ...
  'burdock-root-stir-fry': {
    ...
    badges: ['Vegan', 'Mild'],
    subcategory: 'jorim',
    nameEnOverride: 'Braised Burdock Root',
    glossary: 'Braised burdock root — slow-cooked in a sweet soy glaze until caramelized and tender.',
  ...
  'seasoned-sea-vegetable-wakame': {
    ...
    badges: ['Vegan', 'Mild', 'Gluten-Friendly'],
    subcategory: 'muchim',
    glossary: 'Seasoned Korean seaweed salad — tossed with sesame oil and light vinegar dressing.',
  ...
  'seasoned-fish-cake-odeng-muchim': {
    ...
    subcategory: 'muchim',
    glossary: 'Korean bar snack (anju) — bold, spicy, gochujang-seasoned. Pairs with cold drinks.',
  ...
  'seasoned-squid-ojingeo-muchim': {
    ...
    badges: ['Anju', 'Spicy', 'Drink Pairing'],
    subcategory: 'muchim',
    glossary: 'Korean bar snack (anju) — bold, spicy, gochujang-seasoned squid. Pairs with cold drinks.',
    review: 'Perfect beer pairing for Korean palates. May be a new experience for those unfamiliar with dried seafood banchan \u2014 but worth the try.',
    flavorProfile: 'Bold, spicy, and savory with gochujang-based seasoning.',
    texture: 'Chewy and satisfying. Classic Korean bar food texture.',
    pairsWellWith: 'Korean lager, soju, makgeolli \u2014 the definitive Korean anju',
  ...
  'potato-egg-salad': {
    ...
    subcategory: 'muchim',
    glossary: 'Korean-style potato salad — creamy, mild, and comforting. A crowd favorite.',
  ...
  'sweet-corn-vegetable-salad': {
    ...
    badges: ['Vegan', 'Mild', 'Kids Favorite'],
    subcategory: 'muchim',
    glossary: 'Korean-style corn salad — sweet, creamy, and colorful. Kid-approved.',
  ...
  'pan-fried-dumplings-mandu': {
    ...
    badges: ['High Protein', 'Best Seller'],
    subcategory: 'bokkeum',
    glossary: 'Korean dumplings — pan-fried or steamed, filled with seasoned meat and vegetables.',
  ...
  'korean-egg-roll-gyeran-mari': {
    ...
    badges: ['Mild', 'Kids Favorite'],
    subcategory: 'bokkeum',
    glossary: 'Korean rolled omelette — layers of egg with vegetables folded inside. A lunchbox classic.',
  ...
  'napa-cabbage-kimchi': {
    ...
    subcategory: 'kimchi',
    glossary: 'Classic Korean fermented cabbage — tangy, spicy, deeply savory. The foundation of the Korean table.',
  ...
  'radish-kimchi-kkakdugi': {
    ...
    subcategory: 'kimchi',
    nameKoOverride: '깍두기',
    glossary: 'Cubed radish kimchi — bite-sized Korean radish fermented with gochugaru and aromatics.',
  ...
  'white-kimchi-baek-kimchi': {
    ...
    subcategory: 'kimchi',
    glossary: 'White kimchi — non-spicy, fermented without chili. Mild and refreshing.',
  ...
  'steamed-rice-cake': {
    ...
    glossary: 'Korean rice cake (tteok) — soft, chewy cake made from pounded glutinous rice.',
  ...
  'assorted-flavored-rice-cakes': {
    ...
    glossary: 'Korean rice cakes (tteok) — soft, chewy, in assorted flavors: red bean, sesame, mugwort, honey.',
  ...
  'acorn-jelly-dotori-muk': {
    ...
    spiceLevel: 0,
    badges: ['Vegan', 'Mild', 'Gluten-Friendly'],
    glossary: 'Traditional Korean cold side — firm, silky acorn starch jelly with soy-sesame dressing.',
  ...
  'yuzu-salad': {
    ...
    subcategory: 'muchim',
    glossary: 'Seasonal Korean salad dressed with yuzu citrus — bright, fragrant, and refreshing.',
  ...
  'tofu-vegetable-salad': {
    ...
    subcategory: 'muchim',
    glossary: 'Korean tofu salad — silken tofu with fresh vegetables in a sesame dressing.',
  ...
  'korean-savory-pancake-jeon': {
    ...
    subcategory: 'bokkeum',
    glossary: 'Korean savory pancake — crispy, pan-fried with green onion, kimchi, or seafood.',
  ...
  try {
    ...
    for (const item of rawItems) {
      ...
      const menuItem: MenuItem = {
        id: slug,
        nameKo: enrichment?.nameKoOverride ?? nameKo,
        nameEn: enrichment?.nameEnOverride ?? nameEn,
        description,
        price,
